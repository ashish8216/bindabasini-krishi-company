    ...
    <div class="flex items-center justify-center py-3 bg-gray-100 px-4">
        ...
        <div class="max-w-md w-full p-8 bg-white shadow-xl rounded-2xl">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                {{-- Social Login --}}
                <div class="pt-2">
                    <p class="text-center text-gray-500 text-sm mb-3"> {{ __('Or continue with') }}</p>

                    <div class="flex flex-col space-y-3">

                        {{-- Google Login Button --}}
                        <a href="{{ route('google.login') }}"
                            class="flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 rounded-lg bg-white hover:bg-gray-100 transition">
